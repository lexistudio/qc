  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div class="card__right">
        <div class="content">
          <p v-if="catalogsItem.description">{{ catalogsItem.description }}</p>
          <p>
          ...
          <p>Доставка по Москве и в пределах МКАД осуществляется бесплатно при сумме заказа от 20 000 руб. Доставка за МКАД осуществляется отдельно.</p>
