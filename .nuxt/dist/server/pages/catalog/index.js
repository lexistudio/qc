...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/catalog/index.vue?vue&type=template&id=2ec45ac2&
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._ssrNode("<form class=\"search\"><input type=\"text\" placeholder=\"Поиск по парт номерам\" required=\"required\"" + _vm._ssrAttr("value", _vm.search) + " class=\"form-fields\"> <button class=\"search-btn\"><i class=\"fas fa-search\"></i></button></form> "), _c('Filters', {
    attrs: {
    ...
    staticClass: "content"
  }, [_c('p', [_vm._v("Нет записей...")])])]), _vm._ssrNode(" " + (_vm.preloader ? "<div class=\"preloader\"></div>" : "<!---->") + " " + (_vm.count < _vm.counts && _vm.isPreloaderBtn ? "<div class=\"preloader-btn\">Показать еще</div>" : "<!---->"))], 2);
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/catalog/index.vue?vue&type=template&id=2ec45ac2&
...
installComponents(component, {Filters: __webpack_require__(91).default,CatalogBox: __webpack_require__(83).default})
